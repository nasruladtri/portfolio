...
export const Navbar = () => {
    ...
    return (
        <header className="fixed top-0 inset-x-0 z-50 bg-transparent backdrop-blur-md border-b-2 border-white/30">
            ...
            {open && (
                <div className="sm:hidden border-t-2 border-white/30 bg-white/40 backdrop-blur-xl">
